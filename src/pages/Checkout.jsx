          ...
          <Row>
            ...
            <Col lg='4' md='6'>
              <div className='checkout__bill'>
                <h6 className='d-flex align-items-center justify-content-center mb-3'>Subtotal: <span className='cart__subtotal'>${cartTotalAmount}</span></h6>
                <h6 className='d-flex align-items-center justify-content-center mb-3'>Shipping: <span className="cart__subtotal">${shippingCost}</span></h6>
                <div className='checkout__total'>
                  <h5 className='d-flex align-items-center justify-content-center'>Total: <span className="cart__subtotal">${totalAmount}</span></h5>
                </div>
              </div>
            </Col>
          </Row>
